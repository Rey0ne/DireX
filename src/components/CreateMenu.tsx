...
function MiniIcon({ type }: { type: string }) {
  ...
  switch (type) {
    ...
    case 'tripo': return <svg width="14" height="14" viewBox="0 0 14 14" style={s}><rect x="1" y="1" width="12" height="12" rx="2" fill="none" stroke="currentColor" strokeWidth="1.2"/><path d="M4 10V4l6 3-6 3z" fill="currentColor" opacity="0.6"/></svg>;
