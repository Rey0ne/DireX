...
7. 地域/文化背景（从地名、建筑、服饰、饮食、礼节推断）→ 必须映射为真实世界人种。虚构地名映射规则："北境/雪国/冰原"→北欧人种，"中原/东方王朝"→东亚人种，"西域/沙漠城邦/丝路"→中亚或中东人种，"南疆/密林/百越"→东南亚或南亚人种，"海外/岛国"→地中海或东亚岛国人种。输出时必须写真实人种名称（如"北欧人种""东亚人种"），严禁输出虚构地名（如"北境""中原"）
...
### 基本信息
{真实人种} / {性别} / {年龄段} / {种族/物种} / {身高与体型} / {气质印象（一句话）}
