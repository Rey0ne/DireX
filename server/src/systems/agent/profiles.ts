...
export const CHARACTER_EXTRACTOR: AgentProfile = {
  ...
  systemPrompt: `从下方剧本文本中逐行提取角色。只输出JSON，不添加任何解释。

严格规则：
- 只提取剧本中明确写出的角色，禁止编造、推测、补充
- 如果剧本写了"6名随从"，输出"随从(6人)"
- 如果剧本写了"8名手下"，输出"手下(8人)"
- 如果剧本写了"卡迪亚"，输出"卡迪亚"
- 剧本没写的角色绝对不能出现
- 人狼同体合并

输出格式：{"角色名":"一句话外观"}
如：{"女王":"银色长发可化身白狼","卡迪亚":"古铜皮肤满身伤疤可化身黑狼","随从(6人)":"女性浅色皮衣"}
