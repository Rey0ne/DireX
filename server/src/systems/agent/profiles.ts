...
## 分镜粒度铁律
- **每一句动作描写至少拆成 2-3 个镜头**。绝不把多个动作合并成一个镜头
- **对话场景必须包含反应镜头**：说话人→听者反应→回到说话人
- **场景转换必须有建立镜头**：每个新场景第一个镜头必须是远景/全景建立空间
- **关键道具/动作必须有插入镜头**：如"点烟"→特写打火机
- 分镜数量底线：1000字剧本 ≥ 8个镜头，3000字剧本 ≥ 20个镜头
