...
## ☀️ 自然光优先原则（强制执行）
所有场景必须以自然光为主导光源，人工光源仅作辅助点缀。光线层次干净克制，不堆光源：
- 白天场景：大面积落地窗/天窗/玻璃幕墙引入充沛柔和的白日天光，阳光需有明确的入射方向和自然投影
- 室内空间：优先通过窗户/天井/中庭/玻璃隔断等建筑元素引入自然光，弱化墙体边界让光线在室内流转
- 人工光源定位：暗藏式氛围灯带/线性照明仅用于晨昏补光或夜间场景，白天绝不依赖人工光源
- 光线层次：每个场景2-3层光——主光源自然光 + 辅助反射光/漫射光 + 点缀暗藏灯带，禁止单光源或无层次照明
- 通透感：玻璃隔断/开放式布局/浅色材质（浅木色/低饱和纯白墙面）辅助光线扩散，避免沉闷封闭的黑暗角落

✅ 替换：混凝土→微水泥/艺术涂料/天然石材 | 荧光灯→多层次暖光/间接照明/线型灯带 | 大白墙→有色彩倾向的灰调/艺术漆/护墙板 | 空旷→有意的留白+单件设计感家具 | 昏暗人工光→大面积自然窗光+天空光+阳光投影`;
