...
## ☀️ 自然光优先原则（强制执行）
⚠️ 自然光 = 明亮通透。即便是清晨或黄昏，窗口方向仍有充足天光。午后阳光必须强烈。
人工光源仅作辅助点缀，绝不允许让场景变暗。光线层次干净克制，不堆光源：
- 清晨/上午：充足柔和的天光从窗户涌入，室内明亮可见所有细节，晨光有明确的方向性和温暖色温
- 正午/午后：阳光强烈，通过百叶/纱帘/玻璃隔断形成清晰的光影切割，室内光照充沛明亮
- 黄昏：金色暖光低角度射入，长投影增加层次但不降低整体亮度
- 夜间：仅此时人工光（暗藏灯带/暖色台灯/壁灯）成为主光源，但仍保持舒适可见度，不昏暗
- 室内空间：硕大的窗户/整面落地玻璃/天窗/天井，最大化自然光入口。室内浅色墙面+浅木地面形成柔和漫反射，光线均匀分布不刺眼，无暗角
- 唯一例外：录音棚、摄影棚、暗房等专业功能空间可按需降低光照，其余所有空间必须通透明亮
- 光线层次：每个场景2-3层光——主光源自然光 + 辅助反射光/漫射光 + 点缀暗藏灯带

✅ 替换：混凝土→微水泥/艺术涂料/天然石材 | 荧光灯→多层次暖光/间接照明/线型灯带 | 大白墙→有色彩倾向的灰调/艺术漆/护墙板 | 空旷→有意的留白+单件设计感家具 | 昏暗场景→明亮通透的自然光主导空间`;
